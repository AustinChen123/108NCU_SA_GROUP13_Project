...
public class MemberHelper {
    ...
    public JSONObject deleteByID(int id) {
        ...
        try {
            ...
            /** SQL指令 */
            String sql = "DELETE FROM `sa_project`.`members` WHERE `id` = ? LIMIT 1";
    ...
    public JSONObject getAll() {
        ...
        try {
            ...
            conn = DBMgr.getConnection();
            /** SQL指令 */
            String sql = "SELECT * FROM `sa_project`.`members`";
    ...
    public JSONObject getByEmail(String login_email) {
        ...
        try {
            ...
            conn = DBMgr.getConnection();
            /** SQL指令 */
            String sql = "SELECT * FROM `sa_project`.`members` WHERE `email` = ? LIMIT 1";
    ...
    public boolean checkDuplicate(Member m){
        ...
        try {
            ...
            conn = DBMgr.getConnection();
            /** SQL指令 */
            String sql = "SELECT count(*) FROM `sa_project`.`members` WHERE `email` = ?";
    ...
    public JSONObject update(Member m) {
        ...
        try {
            ...
            conn = DBMgr.getConnection();
            /** SQL指令 */
            String sql = "Update `sa_project`.`members` SET `name` = ? , `fb_link`= ? , `password` = ? , `modified` = ?, `status`= ? WHERE `email` = ?";
            /** 取得所需之參數 */
            String name = m.getName();
            String email = m.getEmail();
            String fb_link=m.getFb_link();
    ...
    public void updateStatus(Member m) {      
        ...
        try {
            ...
            conn = DBMgr.getConnection();
            /** SQL指令 */
            String sql = "Update `sa_project`.`members` SET `status` = 1 WHERE `id` = ?";
            /** 取得會員編號 */
            int id = m.getID();
