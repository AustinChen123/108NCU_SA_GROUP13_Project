...
//    }
     ...
     */
    public Member(int id, String email, String name, String fb_link, String password, String status, Timestamp login_datetime) {
        this.id = id;
        this.email = email;
        this.name = name;
    ...
    public Member(int id, String email, String name, String fb_link) {
        this.id = id;
        this.email = email;
        this.name = name;
        this.fb_link = fb_link;
    ...
    public JSONObject update() {
        ...
        this.login_datetime = new Timestamp(localtime.getTime());
        /** 計算帳戶所屬之組別 */
        calcAccName();
...
//        /** 計算目前分鐘數為偶數或奇數 */
//        String curr_status = (this.login_datetime % 2 == 0) ? "偶數會員" : "奇數會員";
//        /** 將新的會員組別指派至Member之屬性 */
